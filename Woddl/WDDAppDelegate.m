...
#pragma mark - Push Notifications setup
            ...
            [query findObjectsInBackgroundWithBlock:^(NSArray *objects, NSError *error)
             {
                 dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_LOW, 0), ^{
                     ...
                     [[SocialNetworkManager sharedManager] updatePosts]; //do not update posts on applicaiton come from background
                 });
             }];
        }];
    }
...
- (void)applicationDidEnterBackground:(UIApplication *)application
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"displayPoweredByScreen" object:nil];
