...
NSString * kFacebookAccessKey = @"435977526532008";//@"311206962418854";//@"435977526532008";
...
NSString * kLinkedInApiKey = @"77bw1gyn67kx4w";
NSString * kLinkedInSecret = @"jlttCbHPAZl1BcWr";
NSString * kTwitterConsumerKey = @"TQF3NEuJ52b2vdQWV6gPlA";
NSString * kTwitterConsumerSecret = @"GsLERU1Akcl8FXqyUFR2ii8j39BcR6TbBZF0o2CM";
...
NSString * const kNotificationRefetchBasePostSreenTable = @"com.ids.reloadBasePostTableNotification";
