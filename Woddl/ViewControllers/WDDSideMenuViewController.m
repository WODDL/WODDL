...
@property (assign, nonatomic)WDDSocialNetworkCell *cell;
...
{
    self.cell = [tableView dequeueReusableCellWithIdentifier:kSocialNetworkCellIdentifier forIndexPath:indexPath];
...
- (void)changeFilterType:(UITapGestureRecognizer *)gestureRecognizer
{
   ...
   // [self performSegueWithIdentifier:@"SettingsIDS" sender:self];
