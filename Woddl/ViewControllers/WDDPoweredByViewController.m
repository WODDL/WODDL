...
@property (nonatomic, strong)IBOutlet UIButton *advertBtn;
...
- (void)viewDidLoad
{
    ...
    if (poweredByImage)
    {
        ...
        [self.advertBtn setBackgroundImage:poweredByImage forState:UIControlStateNormal];
    }
    else
    {
        [self.backgroundImage setImage:[UIImage imageNamed:@"loadingPage.png"]];//ASSET_BY_SCREEN_HEIGHT(@"PoweredByScreen_background")];
        self.backgroundImage.contentMode = UIViewContentModeBottom;
        [self.advertBtn setBackgroundImage:[UIImage imageNamed:@"loadingPage.png"] forState:UIControlStateNormal];
    }
    ...
    [countryQuery whereKey:@"countryCode" equalTo:@"default"];//TODO: chenge to countyCode when setupped
    ...
    [query findObjectsInBackgroundWithBlock:^(NSArray *objects, NSError *error) {
        ...
        [objects enumerateObjectsUsingBlock:^(id obj, NSUInteger idx, BOOL *stop) {
            ...
            if ([object[@"countryCode"] isEqual:countyCode] || [object[@"countryCode"] isEqual:@"default"])
            {
...
const NSTimeInterval kPresentPoweredByDelay = 2.5f;
...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    if ([PFUser currentUser])
    {
        ...
        [WDDDataBase initializeWithCallBack:^(BOOL success) {
            ...
            NSTimeInterval timeToShow = kPresentPoweredByDelay ;
    ...
    else
    {
        ...
        [self performSelector:@selector(goToLoginScreen) withObject:nil afterDelay:kPresentPoweredByDelay];
    }
}
