...
@interface WDDReadLaterViewController ()<UIGestureRecognizerDelegate>
...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    //[Heatmaps trackScreenWithKey:@"503395516a70d21a-31180221"];//ROMA
}
...
{
    CGPoint pointInSrc = [gestureRecognizer locationInView:self.view];
