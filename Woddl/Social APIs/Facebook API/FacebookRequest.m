...
//  Woddl
//
//  Created by Oleg Komaristov on 05.11.13.
...
static NSInteger const kMaxCountOfPostsInUpdate = 10;
...
//            [[[UIAlertView alloc] initWithTitle:@"Reloading..." message:@"No new posts.Try later." delegate:self cancelButtonTitle:@"Ok" otherButtonTitles:nil] show];
//        });
//        
//    }
                 ...
                 toGroupWithID:(NSString *)groupID
{
    ...
    [params s_setObject:message forKey:@"description"];
    [params s_setObject:@"WOODL" forKey:@"name"];
    [params s_setObject:@"www.woddl.com" forKey:@"caption"];
    ...
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat: @"https://graph.facebook.com/me/links"]] cachePolicy:NSURLRequestReloadIgnoringCacheData timeoutInterval:kInternetIntervalTimeout];
    ...
    [params s_setObject:@"WOODL" forKey:@"title"];
    ...
    NSString *requestString = [[NSString stringWithFormat: @"https://graph.facebook.com/%@/%@", groupID==nil? @"me":groupID,imageURL!=nil? @"photos":@"feed"] stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:[NSURL URLWithString:requestString]
                                                           cachePolicy:NSURLRequestReloadIgnoringCacheData
                                                       timeoutInterval:kInternetIntervalTimeout];
    ...
    NSData* data = [NSURLConnection sendSynchronousRequest:request returningResponse:&response error:&error];
    NSString* status = [[NSString alloc] initWithData:data encoding:NSUTF8StringEncoding];
    NSDictionary *res=[NSDictionary dictionaryWithObjectsAndKeys:status,@"status", nil];
    NSLog(@"RESPOND %@",[res objectForKey:@"status"]);
    if([status rangeOfString:@"id"].location != NSNotFound)
    {
        return YES;
    }
